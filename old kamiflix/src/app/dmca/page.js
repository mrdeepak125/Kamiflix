    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          kamiflix.xyz is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on kamiflix.xyz are hosted on our servers. All
          ...
          to{" "}
          <Link href="mailto:info@cienflow.us" className="text-white">
            contact@kamiflix.xyz
          </Link>{" "}
